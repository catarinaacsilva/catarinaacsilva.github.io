...
\begin{frame}
\frametitle{Como Cada Nível Distribui os Dados}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a10-niveis-raid.png}
\end{center}
\vfill
\end{frame}
...
\begin{frame}
\frametitle{A Pilha Completa de Armazenamento}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a10-pilha-armazenamento.png}
\end{center}
\vfill
\end{frame}
