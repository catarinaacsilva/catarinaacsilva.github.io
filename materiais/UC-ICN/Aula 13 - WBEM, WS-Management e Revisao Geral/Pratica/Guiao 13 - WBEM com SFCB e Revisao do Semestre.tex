...
\begin{itemize}[itemsep=0.2cm]
  \item Correr um CIMOM local (SFCB) num container Docker e consultá-lo com um cliente WBEM.
...
\begin{itemize}[itemsep=0.3cm]
  ...
  \item \textbf{C2 (Aulas 03-04)}: Comparar hipervisores tipo 1 vs tipo 2 e explicar porque é que um container partilha o kernel do host enquanto uma VM não. Rever o papel de namespaces e cgroups.
