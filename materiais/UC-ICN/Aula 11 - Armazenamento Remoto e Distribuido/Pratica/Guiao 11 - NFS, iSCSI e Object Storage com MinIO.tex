...
\begin{itemize}
    \setlength\itemsep{0.2cm}
    \item Duas VMs Linux no Proxmox, na mesma rede: uma no papel de servidor
    (\texttt{servidor}) e outra no de cliente (\texttt{cliente}). Pode reutilizar VMs
    de aulas anteriores.
...
\begin{enumerate}[label=\alph*)]
    ...
    \item (Se fez a Parte E) O volume NFS foi declarado com o modo de acesso
    \texttt{ReadWriteMany}. Porque é que isso foi possível? Que modo teria de usar
    se o volume fosse iSCSI, e porquê?
