...
\begin{frame}
\frametitle{Quem Gere o Sistema de Ficheiros}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a11-nas-vs-san.png}
\end{center}
\vfill
\end{frame}
...
\begin{itemize}
    \setlength\itemsep{0.4cm}
    \item Modelo baseado em \textbf{buckets} (containers) e \textbf{objetos} identificados por uma chave, com metadados associados.
...
\begin{frame}
\frametitle{CAP e PACELC}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a11-cap-pacelc.png}
\end{center}
\vfill
\end{frame}
