...
\begin{frame}
\frametitle{Acoplado vs Desacoplado}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a09-sinc-assinc.png}
\end{center}
\vfill
\end{frame}
...
\begin{frame}
\frametitle{O Caminho de uma Mensagem}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a09-amqp.png}
\end{center}
\vfill
\end{frame}
...
\begin{frame}
\frametitle{Work Queue vs Publish/Subscribe}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a09-padroes.png}
\end{center}
\vfill
\end{frame}
