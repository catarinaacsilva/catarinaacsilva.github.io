...
\end{lstlisting}
  ...
  Compare agora com um valor do tipo \texttt{Gauge32}, que sobe e desce livremente.
  O OID \texttt{tcpCurrEstab} indica quantas ligações TCP estão estabelecidas neste momento:
\begin{lstlisting}
$ snmpget -v2c -c icnturma IP_da_VM 1.3.6.1.2.1.6.9.0
$ sleep 5
$ snmpget -v2c -c icnturma IP_da_VM 1.3.6.1.2.1.6.9.0
\end{lstlisting}
  Aqui o valor absoluto \emph{é} informativo, e pode diminuir entre leituras -- ao contrário do contador anterior.
