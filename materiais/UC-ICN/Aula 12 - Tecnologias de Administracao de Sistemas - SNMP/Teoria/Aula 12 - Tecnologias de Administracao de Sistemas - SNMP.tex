...
\begin{frame}
\frametitle{Polling e Push}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a12-arquitetura-snmp.png}
\end{center}
\vfill
\end{frame}
...
\begin{frame}
\frametitle{A Árvore MIB}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a12-arvore-mib.png}
\end{center}
\vfill
\end{frame}
