...
\begin{itemize}
    \setlength\itemsep{0.4cm}
    \item Open vSwitch e redes de containers/Kubernetes.
...
\begin{frame}
\frametitle{Onde Vive a Decisão}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a06-planos.png}
\end{center}
\vfill
\end{frame}
...
\begin{frame}
\frametitle{O Percurso de um Pacote sem Regra}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a06-packet-in.png}
\end{center}
\vfill
\end{frame}
...
\begin{itemize}
    ...
    \item Substitui a bridge de rede tradicional em hosts que correm máquinas virtuais ou containers.
...
\begin{itemize}
    ...
    \item Permite milhões de segmentos de rede lógicos e mobilidade de VMs/containers entre servidores físicos sem reconfigurar a rede física.
\end{itemize}
\end{frame}
...
\begin{frame}
\frametitle{Overlay sobre Underlay}
\vfill
\begin{center}
\includegraphics[width=0.97\textwidth,height=0.70\textheight,keepaspectratio]{../Diagramas/a06-overlay.png}
\end{center}
\vfill
\end{frame}
...
\begin{itemize}
    ...
    \item Open vSwitch materializa este modelo em hipervisores e infraestrutura de containers.
\end{itemize}
\end{frame}
